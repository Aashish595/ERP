...
const schema = z.object({
  ...
  SMTP_USE_TLS: booleanFromString,
  ...
  BBB_TIMEOUT_MS: z.coerce.number().int().positive().default(15_000),
  BBB_CHECKSUM_ALGORITHM: z.enum(["sha1", "sha256", "sha384", "sha512"]).default("sha1"),
});
